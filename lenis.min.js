  ...
  var p = class {
    ...
    onVirtualScroll = (e) => {
      ...
      if (
        ...
        this.isIos &&
        (r.type === `touchstart` &&
          (this._isDraggingSelection = this.isTouchOnSelectionHandle(r)),
    ...
    scrollTo(
      ...
      if (
        (this.prefersReducedMotion &&
          (a ? (r = !0) : ((o = 1), (s = void 0), (c = void 0))),
        (this.isStopped || this.isLocked) && !d)
      )
        return;
      let m = e,
        h = n;
      if (typeof m == `string` && [`top`, `left`, `start`, `#`].includes(m))
        m = 0;
      else if (typeof m == `string` && [`bottom`, `right`, `end`].includes(m))
        m = this.limit;
      else {
        let e = null;
        if (
    ...
    get scroll() {
      return this.options.infinite
        ? i(this.animatedScroll, this.limit)
        : this.animatedScroll;
    }
    get progress() {
